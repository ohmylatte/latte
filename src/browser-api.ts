...
const shippedRoles:AgentRole[] = [
 {id:'assistant',name:'Asistente',initial:'A',summary:'Trabaja el brief con vos sin un rol fijo.',builtin:true,tier:'balanced',avatar:'short.2.2.lanyard'},
 {id:'strategist',name:'Strategist',initial:'S',summary:'Compara opciones y documenta decisiones.',builtin:false,tier:'deep',avatar:'bun.2.1.glasses-thick'},
 {id:'researcher',name:'Researcher',initial:'R',summary:'Contrasta evidencia y fuentes.',builtin:false,tier:'light',avatar:'curly.1.3.glasses-round'},
 {id:'analyst',name:'Analyst',initial:'A',summary:'Interpreta datos y explicita límites.',builtin:false,tier:'balanced',avatar:'short.4.1.glasses'},
...
listHandoffs:async()=>[],dismissHandoff:unavailable,listSkills:async()=>[],setSkillEnabled:unavailable,listSkillCandidates:async()=>[],approveSkillCandidate:unavailable,rejectSkillCandidate:unavailable,promoteSkillCandidate:unavailable,applyFunnelProposal:unavailable,dismissFunnelProposal:unavailable,trackFile:unavailable,
  ...
  getCoordinationEnabled:async()=>true,setCoordinationEnabled:unavailable,getCoordinationGlobalBudget:async()=>({state:'unset'}),setCoordinationGlobalBudget:unavailable,markCoordinationSeen:unavailable,listCoordinationHires:async()=>[],listCoordinationTasks:async()=>[],listCoordinationMessages:async()=>[],
  onCoordinationEvent:()=>()=>{},
  ...
  listTeam: async () => [], listBrandTeam: async () => [], addBrandMember: unavailable, retireBrandMember: unavailable, callUpMember: unavailable, addTeamMember: unavailable, openTeamMember: unavailable, pauseTeamMember: unavailable, finishTeamMember: unavailable, restartTeamMember: unavailable, removeTeamMember: unavailable, setTeamMemberModel: unavailable, setTeamMemberTier: unavailable, draftContinuation: unavailable,
