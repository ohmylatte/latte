...
const METHODS = [
  ...
  'coordinationRuntimeSupport','listActiveCoordinationRuns','getCoordinationGlobalBudget','setCoordinationGlobalBudget','markCoordinationSeen','listCoordinationHires','listCoordinationTasks','listCoordinationMessages',
  'runtimeStatus',
  'startAgent',
  'writeAgent',
  'resizeAgent',
