...
const es = {
  ...
  'team.run.counts': '{done} listas · {failed} fallidas · {pending} sin empezar',
  'team.run.budget': 'Despachos: {used} / {max}',
...
const en: Record<MessageKey, string> = {
  ...
  'team.run.counts': '{done} done · {failed} failed · {pending} not started',
  'team.run.budget': 'Dispatches: {used} / {max}',
