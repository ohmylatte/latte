...
export const API_ARITY: Record<ApiMethod, number> = {
  ...
  coordinationRuntimeSupport:1,listActiveCoordinationRuns:0,getCoordinationGlobalBudget:0,setCoordinationGlobalBudget:1,markCoordinationSeen:1,listCoordinationHires:1,listCoordinationMessages:1,
  runtimeStatus: 0,
  startAgent: 2,
  writeAgent: 2,
  resizeAgent: 3,
