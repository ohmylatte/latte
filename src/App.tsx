...
import { useTeamSeen } from './useTeamSeen';
...
export function App() {
  ...
  /** E4: Marca → Identidad. Se lee al entrar a la vista; cada acción devuelve la vista nueva. */
  ...
  useEffect(() => {
    ...
    if (!brand || view !== 'identity') { setIdentity(null); return; }
    let live = true;
  ...
  /**
   * H1: que runs ya mostraron su equipo. La linea "Plan aprobado" avisa una
   * vez y se va; el "visto" se anota cuando el run YA tiene el plan aprobado,
   * porque abrir el equipo mientras el coordinador todavia esta planificando
