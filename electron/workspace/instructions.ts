...
export function renderInstructionBundle(input: InstructionsInput): InstructionBundle {
  ...
  const run = (includeLearned: boolean) => {
    let rendered = renderCore(input, DECISIONS_INLINE_MAX, BRAND_CONTEXT_CHARS, includeLearned, INHERITED_DECISIONS_INLINE_MAX, INHERITED_ARTIFACTS_INLINE_MAX);
    ...
    if (overCap) {
      rendered = renderCore(input, DECISIONS_INLINE_FLOOR, BRAND_CONTEXT_CHARS, includeLearned, INHERITED_DECISIONS_INLINE_FLOOR, INHERITED_ARTIFACTS_INLINE_MAX);
    }
    if (overCap && !fits(rendered.text)) {
      rendered = renderCore(input, DECISIONS_INLINE_FLOOR, BRAND_CONTEXT_CHARS_FLOOR, includeLearned, INHERITED_DECISIONS_INLINE_FLOOR, INHERITED_ARTIFACTS_INLINE_FLOOR);
    }
